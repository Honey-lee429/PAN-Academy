...
public class PilhasIteracao {
	...
	public static void main(String[] args) {
		...
		java.util.Iterator<String> iterList =listList.iterator();
		...
		java.util.Iterator<String> iterArray = listArray.iterator();
		...
		java.util.Iterator<Integer> iterPilha = pilhaList.iterator();
